...
class ControllerPaymentWesternUnion extends Controller {
	...
	public function index() {
		...
		foreach ($languages as $language) {
			if (isset($this->error['western_union_' . $language['language_id']])) {
				$this->data['error_western_union' . $language['language_id']] = $this->error['bank_' . $language['language_id']];
			} else {
				$this->data['error_western_union' . $language['language_id']] = '';
			}
		}
		...
		foreach ($languages as $language) {
			if (isset($this->request->post['western_union' . $language['language_id']])) {
				$this->data['western_union' . $language['language_id']] = $this->request->post['western_union' . $language['language_id']];
			} else {
				$this->data['western_union' . $language['language_id']] = $this->config->get('western_union' . $language['language_id']);
			}
		}
	...
	private function validate() {
		...
		foreach ($languages as $language) {
			if (!$this->request->post['western_union' . $language['language_id']]) {
				$this->error['western_union' .  $language['language_id']] = $this->language->get('error_western_union');
			}
		}
